...
1. **Technical spike Daily → KZ S3** — см. [PRDT-01-01-02-daily](./PRDT-01-01-02-daily.md)
2. Click-through прототип шагов 1–3 (онбординг → вакансия → назначение встречи)
3. Описать модель данных: компания, вакансия, кандидат, этап, встреча, оффер
4. Согласовать интеграцию HH (API / OAuth)
5. Проработать экран «топ кандидатов + рекомендации к интервью»
